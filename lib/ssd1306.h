...
#define I2C_PORT_DISP i2c1 // Porta I2C
#define WIDTH 128 // Largura
#define HEIGHT 64 // Altura
#define I2C_SDA_DISP 14 // Pino SDA
#define I2C_SCL_DISP 15 // Pino SCL
...
void display_weather(ssd1306_t *ssd, float bmp280_temperature, float bmp280_altitude, float aht20_temperature, float aht20_humidity, bool web_server_initialized, bool cor); // Atualiza o conteúdo do display com dados do tempo
void ssd1306_clear(ssd1306_t *ssd); // Limpa o display OLED SSD1306
void start_display(ssd1306_t *ssd); // Inicia a exibição da tela de início
void status_display(ssd1306_t *ssd, const char *string1, const char *string2); // Inicia a exibição da tela de status
